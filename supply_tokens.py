...
def main():
    ...
    dafiToken = Contract.from_explorer("0xeaad65885fea47a3b1258935f4ce83aab06fdd3a")
    ...
    dafiWhale = accounts.at("0xfeb4acf3df3cdea7399794d0869ef76a6efaff52", force=True)
    ...
    for account in testAccounts:
        ...
        dafiToken.transfer(account, "250 ether", {'from': dafiWhale})
